    ...
    <div className="flex min-h-screen">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <div className="flex items-center">
              ...
              <h1 className="ml-2 text-2xl font-bold text-indigo-600">Dagbok</h1>
            </div>
            <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Acesse sua conta</h2>
          ...
          <div className="mt-10">
            <div>
              {error && (
                <div className="mb-4 p-3 bg-red-50 text-red-700 rounded-md border-l-4 border-red-500">
                  {error}
                </div>
              )}
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm/6">
                    <Link href="/esqueci-senha" className="font-semibold text-indigo-600 hover:text-indigo-500">
                      Esqueceu a senha?
                    </Link>
                  </div>
                </div>
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        <img
          ...
          alt="Pessoa escrevendo currículo"
        />
      </div>
    </div>
  );
